...
extern "C"
{
	...
	inline void NVec2f64Add(NVEC2f64 *vr, const NVEC2f64 *v1, const NVEC2f64 *v2)
	{
		vr->x = v1->x + v2->x;
		vr->y = v1->y + v2->y;
	}
	inline void NVec2f64AddTo(NVEC2f64 *v1, const NVEC2f64 *v2)
	{
		v1->x += v2->x;
		v1->y += v2->y;
	}
	...
	inline void NVec2f64Set(NVEC2f64 *v, const Nf32 x, const Nf32 y)
	{
		v->x = x;
		v->y = y;
	}
	inline void NVec2f64Scale(NVEC2f64 *dest, const NVEC2f64 *src, const Nf64 factor)
	{
		dest->x = src->x * factor;
		dest->y = src->y * factor;
	}
	inline void NVec2f64ScaleBy(NVEC2f64 *v, const Nf32 factor)
	{
		v->x *= factor;
		v->y *= factor;
	}
	...
	inline void NVec2f64Sub(NVEC2f64 *vr, const NVEC2f64 *v1, const NVEC2f64 *v2)
	{
		vr->x = v1->x - v2->x;
		vr->y = v1->y - v2->y;
	}
	inline void NVec2f64SubFrom(NVEC2f64 *v1, const NVEC2f64 *v2)
	{
		v1->x -= v2->x;
		v1->y -= v2->y;
	}
	inline void NVec2f64Null(NVEC2f64 *v)
	{
		v->x = 0;
		v->y = 0;
	}
	inline Nbool NVec2f64IsUnit(const NVEC2f64 *v) { return (NABS(1.0 - NVec2f64Length(v)) < NF32_EPSILON_VECTOR_LENGTH ? 1 : 0); }
	inline void NVec2f64Lerp(NVEC2f64 *vr, const NVEC2f64 *vorigin, const NVEC2f64 *v, const Nf64 t)
	{
