...
extern "C"
{
	...
	// **								 Functions											**
	// ***************************************************************************************
	inline void NVec3CrossProduct(NVEC3 *vr, const NVEC3 *v1, const NVEC3 *v2)
	{
	...
	inline void NVec3Add(NVEC3 *vr, const NVEC3 *v1, const NVEC3 *v2)
	{
		vr->x = v1->x + v2->x;
		vr->y = v1->y + v2->y;
		vr->z = v1->z + v2->z;
	}
	inline void NVec3AddTo(NVEC3 *v1, const NVEC3 *v2)
	{
		v1->x += v2->x;
		v1->y += v2->y;
		v1->z += v2->z;
	...
	inline void NVec3SubFrom(NVEC3 *v1, const NVEC3 *v2)
	{
		v1->x -= v2->x;
		v1->y -= v2->y;
		v1->z -= v2->z;
	}
	inline void NVec3Null(NVEC3 *v)
	{
		v->x = 0;
		v->y = 0;
		v->z = 0;
	...
	inline void NVec3Lerp(NVEC3 *vr, const NVEC3 *vorigin, const NVEC3 *v, const Nf32 t)
	{
