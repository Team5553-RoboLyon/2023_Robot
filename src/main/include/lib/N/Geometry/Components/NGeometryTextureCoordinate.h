...
inline	void	NSetTexCoord2s(NTEXCOORD_2s *ptxc,const Ns16 u,const Ns16 v){ptxc->x = u; ptxc->y = v;}
inline	void	NSetTexCoord2f(NTEXCOORD_2f *ptxc,const Nf32 u,const Nf32 v){ptxc->x = u; ptxc->y = v;}
inline	void	NSetTexCoord3f(NTEXCOORD_3f *ptxc,const Nf32 u,const Nf32 v,const Nf32 w){ptxc->x = u; ptxc->y = v; ptxc->z = w;}
