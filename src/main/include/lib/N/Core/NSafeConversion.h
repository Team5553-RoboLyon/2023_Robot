...
// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    inline Nu32 _debug_safeNu32to4BitsValue(Nu32 val)
    {
        NErrorIf(val > 15, NERROR_4BITS_VALUE_OUTOFRANGE);
        return val;
    }
    inline Nu8 _debug_safeNu32toNu8(Nu32 val)
    {
        NErrorIf(val > NU8_MAX, NERROR_NU8_OUTOFRANGE);
        return (Nu8)val;
    }
    inline Nu16 _debug_safeNu32toNu16(Nu32 val)
    {
        NErrorIf(val > NU16_MAX, NERROR_NU16_OUTOFRANGE);
        return (Nu16)val;
    }

    inline Nu32 _debug_safeNs32to4BitsValue(Ns32 val)
    {
        NErrorIf(val > 15 || val < 0, NERROR_4BITS_VALUE_OUTOFRANGE);
        return val;
    }
    inline Nu8 _debug_safeNs32toNu8(Ns32 val)
    {
        NErrorIf(val > NU8_MAX || val < 0, NERROR_NU8_OUTOFRANGE);
        return (Nu8)val;
    }
    inline Nu16 _debug_safeNs32toNu16(Ns32 val)
    {
        NErrorIf(val > NU16_MAX || val < 0, NERROR_NU16_OUTOFRANGE);
        return (Nu16)val;
    }
    inline Nu32 _debug_safeNs32toNu32(Ns32 val)
    {
        NErrorIf(val < 0, NERROR_NU32_NEGATIVE_VALUE_OUTOFRANGE);
        return (Nu32)val;
    }

    inline Nu32 _debug_safeNinttoNs32(Nint val)
    {
        NErrorIf(val < -NS32_MAX || val > NS32_MAX, NERROR_NS32_OUTOFRANGE);
        return (Ns32)val;
    }
    inline Nu8 _debug_safeNinttoNu8(Nint val)
    {
        NErrorIf(val > NU8_MAX || val < 0, NERROR_NU8_OUTOFRANGE);
        return (Nu8)val;
    }
