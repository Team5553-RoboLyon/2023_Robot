...
inline void	NSetupParticleEmitterComponent_Advanced_Desc_BirthExtentsf_Params(NPARTICLE_EMITTERCOMPONENT_ADVANCED_DESC *pdesc,const Nf32 xbase, const Nf32 ybase, const Nf32 xvar,const Nf32 yvar){FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_ADVANCED_DESC_USE_BIRTH_EXTENTS_AND_VARIATION);NVec2Set(&pdesc->BirthExtents.Base,xbase,ybase);NVec2Set(&pdesc->BirthExtents.Variation,xvar,yvar);}
inline void	NSetupParticleEmitterComponent_Advanced_BirthExtents_SetupHandle(NPARTICLE_EMITTERCOMPONENT_ADVANCED_DESC *pdesc,const NPARTICLE_SETUP_EXTENTS phandle){FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_ADVANCED_DESC_USE_SETUPEXTENTS_HANDLE);pdesc->pAdvancedParticle_SetupExtents = phandle;}
inline void	NSetupParticleEmitterComponent_Advanced_Update_CallBack(NPARTICLE_EMITTERCOMPONENT_ADVANCED_DESC *pdesc,const NPARTICLECOMPONENT_ADVANCED_CALLBACK pcallback){FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_ADVANCED_DESC_USE_UPDATE_CALLBACK);pdesc->pAdvancedParticle_UpdateCallBack = pcallback;}
inline void	NSetupParticleEmitterComponent_Advanced_Death_CallBack(NPARTICLE_EMITTERCOMPONENT_ADVANCED_DESC *pdesc,const NPARTICLECOMPONENT_ADVANCED_CALLBACK pcallback){FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_ADVANCED_DESC_USE_DEATH_CALLBACK);pdesc->pAdvancedParticle_DeathCallBack = pcallback;}
