...
#define FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_KEEP_REF_ON_TARGETPOINT BIT_3		  // |     |     |  O	 |  O  |     |     |
	...
	inline void NSetupParticleEmitterComponent_Homing_Desc_DefaultEmissionPoint(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const NVEC3 *pv)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_DEFAULT_EMISSION_POINT);
		pdesc->DefaultEmissionPoint = *pv;
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_DefaultEmissionPointf(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 x, const Nf32 y, const Nf32 z)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_DEFAULT_EMISSION_POINT);
		NVec3Set(&pdesc->DefaultEmissionPoint, x, y, z);
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_DefaultTargetPoint(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const NVEC3 *pv)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_DEFAULT_TARGET_POINT);
		pdesc->DefaultTargetPoint = *pv;
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_DefaultTargetPointf(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 x, const Nf32 y, const Nf32 z)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_DEFAULT_TARGET_POINT);
		NVec3Set(&pdesc->DefaultTargetPoint, x, y, z);
	}

	inline void NSetupParticleEmitterComponent_Homing_Desc_FromTargetDistanceThreshold(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 dist)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_FROM_TARGET_DIST_THRESHOLD);
		pdesc->FromTargetDistanceThreshold = dist;
	}

	inline void NSetupParticleEmitterComponent_Homing_Desc_CartesianEmissionExtentsf(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 x, const Nf32 y, const Nf32 z)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_EMISSION_EXTENTS);
		NVec3Set(&pdesc->EmissionExtents.Cartesian, x, y, z);
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_FastSphericEmissionExtentsf(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 radius, const Nu32 inclination, const Nu32 azimuth)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_EMISSION_EXTENTS);
		NSetFastSphericf(&pdesc->EmissionExtents.FastSpheric, radius, inclination, azimuth);
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_FastCylindricEmissionExtentsf(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 radius, const Nf32 height, const Nu32 azimuth)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_EMISSION_EXTENTS);
		NSetFastCylindricf(&pdesc->EmissionExtents.FastCylindric, radius, height, azimuth);
	}

	inline void NSetupParticleEmitterComponent_Homing_Desc_CartesianTargetExtentsf(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 x, const Nf32 y, const Nf32 z)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_TARGET_EXTENTS);
		NVec3Set(&pdesc->TargetExtents.Cartesian, x, y, z);
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_FastSphericTargetExtentsf(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 radius, const Nu32 inclination, const Nu32 azimuth)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_TARGET_EXTENTS);
		NSetFastSphericf(&pdesc->TargetExtents.FastSpheric, radius, inclination, azimuth);
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_FastCylindricTargetExtentsf(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 radius, const Nf32 height, const Nu32 azimuth)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_TARGET_EXTENTS);
		NSetFastCylindricf(&pdesc->TargetExtents.FastCylindric, radius, height, azimuth);
	}

	inline void NSetupParticleEmitterComponent_Homing_Desc_SpeedDamping(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 speeddamping)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_SPEEDDAMPING);
		pdesc->SpeedDamping = speeddamping;
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_LifeSpan_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 base, const Nf32 var)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_LIFESPAN_AND_VARIATION);
		pdesc->LifeSpan.Base = base;
		pdesc->LifeSpan.Variation = var;
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_BirthRotation_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 base, const Nf32 var)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_BIRTH_ROTATION_AND_VARIATION);
		pdesc->BirthRotation.Base = base;
		pdesc->BirthRotation.Variation = var;
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_BirthRotationSpeed_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 base, const Nf32 var)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_BIRTH_ROTATIONSPEED_AND_VARIATION);
		pdesc->BirthRotationSpeed.Base = base;
		pdesc->BirthRotationSpeed.Variation = var;
	}

	inline void NSetupParticleEmitterComponent_Homing_Desc_BirthSpeed_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 base, const Nf32 var)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_BIRTH_SPEED_AND_VARIATION);
		pdesc->BirthSpeed.Base = base;
		pdesc->BirthSpeed.Variation = var;
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_BirthAcceleration_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 base, const Nf32 var)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_BIRTH_ACCELERATION_AND_VARIATION);
		pdesc->BirthAcceleration.Base = base;
		pdesc->BirthAcceleration.Variation = var;
	}

	inline void NSetupParticleEmitterComponent_Homing_Desc_CartesianEmissionTangentf_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 xbase, const Nf32 ybase, const Nf32 zbase, const Nf32 xvar, const Nf32 yvar, const Nf32 zvar)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_EMISSION_TANGENT_AND_VARIATION);
		NVec3Set(&pdesc->EmissionTangent.Base.Cartesian, xbase, ybase, zbase);
		NVec3Set(&pdesc->EmissionTangent.Variation.Cartesian, xvar, yvar, zvar);
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_FastSphericEmissionTangentf_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 radiusbase, const Nu32 inclibase, const Nu32 azimbase, const Nf32 radiusvar, const Nu32 inclivar, const Nu32 azimvar)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_EMISSION_TANGENT_AND_VARIATION);
		NSetFastSphericf(&pdesc->EmissionTangent.Base.FastSpheric, radiusbase, inclibase, azimbase);
		NSetFastSphericf(&pdesc->EmissionTangent.Variation.FastSpheric, radiusvar, inclivar, azimvar);
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_FastCylindricEmissionTangentf_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 radiusbase, const Nf32 hbase, const Nu32 azimbase, const Nf32 radiusvar, const Nf32 hvar, const Nu32 azimvar)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_EMISSION_TANGENT_AND_VARIATION);
		NSetFastCylindricf(&pdesc->EmissionTangent.Base.FastCylindric, radiusbase, hbase, azimbase);
		NSetFastCylindricf(&pdesc->EmissionTangent.Variation.FastCylindric, radiusvar, hvar, azimvar);
	}

	inline void NSetupParticleEmitterComponent_Homing_Desc_CartesianTargetTangentf_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 xbase, const Nf32 ybase, const Nf32 zbase, const Nf32 xvar, const Nf32 yvar, const Nf32 zvar)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_TARGET_TANGENT_AND_VARIATION);
		NVec3Set(&pdesc->TargetTangent.Base.Cartesian, xbase, ybase, zbase);
		NVec3Set(&pdesc->TargetTangent.Variation.Cartesian, xvar, yvar, zvar);
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_FastSphericTargetTangentf_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 radiusbase, const Nu32 inclibase, const Nu32 azimbase, const Nf32 radiusvar, const Nu32 inclivar, const Nu32 azimvar)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_TARGET_TANGENT_AND_VARIATION);
		NSetFastSphericf(&pdesc->TargetTangent.Base.FastSpheric, radiusbase, inclibase, azimbase);
		NSetFastSphericf(&pdesc->TargetTangent.Variation.FastSpheric, radiusvar, inclivar, azimvar);
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_FastCylindricTargetTangentf_Params(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const Nf32 radiusbase, const Nf32 hbase, const Nu32 azimbase, const Nf32 radiusvar, const Nf32 hvar, const Nu32 azimvar)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_TARGET_TANGENT_AND_VARIATION);
		NSetFastCylindricf(&pdesc->TargetTangent.Base.FastCylindric, radiusbase, hbase, azimbase);
		NSetFastCylindricf(&pdesc->TargetTangent.Variation.FastCylindric, radiusvar, hvar, azimvar);
	}

	inline void NSetupParticleEmitterComponent_Homing_Desc_LocalEmissionPosition_SetupHandle(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const NPARTICLE_SETUP_POSITION phandle)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_SETUP_LOCALEMISSIONPOSITION_HANDLE);
		pdesc->pParticleSetupLocalEmissionPosition = phandle;
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_LocalTargetPosition_SetupHandle(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const NPARTICLE_SETUP_POSITION phandle)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_SETUP_LOCALTARGETPOSITION_HANDLE);
		pdesc->pParticleSetupLocalTargetPosition = phandle;
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_EmissionTangent_SetupHandle(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const NPARTICLE_SETUP_TANGENT phandle)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_SETUP_EMISSIONTANGENT_HANDLE);
		pdesc->pParticleSetupEmissionTangent = phandle;
	}
	inline void NSetupParticleEmitterComponent_Homing_Desc_TargetTangent_SetupHandle(NPARTICLE_EMITTERCOMPONENT_HOMING_DESC *pdesc, const NPARTICLE_SETUP_TANGENT phandle)
	{
		FLAG_ON(pdesc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_HOMING_DESC_USE_SETUP_TARGETTANGENT_HANDLE);
		pdesc->pParticleSetupTargetTangent = phandle;
	}
