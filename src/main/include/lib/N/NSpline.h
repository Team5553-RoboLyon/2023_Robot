...
inline void NBezierCurvatureRadius2f32(NVEC2f32 *R, const Nf32 t, const NSPLINEKNOT *A, const NSPLINEKNOT *B)
{
	...
	//  Le "vecteur Rayon" est le vecteur Normal � la tangente ( connue grace � la deriv�e  d ) de longeur R.
	...
	// On peut optimiser en supprimant la racine carr�e au numerateur et la racine carr�e au denominateur !
