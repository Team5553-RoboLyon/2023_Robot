...
extern "C"
{
	...
	inline void NUT_UIDesk_StoreUIDummyDataf(const Nf32 x, const Nf32 y, const Nf32 z, const Nf32 sx, const Nf32 sy, const Nf32 sz)
	{
		NVEC3 pos;
		NVEC3 size;
		NVec3Set(&pos, x, y, z);
		NVec3Set(&size, sx, sy, sz);
		NUT_UIDesk_StoreUIDummyData(&pos, &size);
	}
// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#ifdef __cplusplus
}
