...
inline void NUT_SetEditorATxC_Elements_Texture(NUT_EDITOR_ATXC_ELEMENTS *pelements, const Nu8 texture_unit, const NTEXTURE *ptexture  ){pelements->MetaTextureType[texture_unit]=NUT_EDITOR_ATXC_ELEMENTS_TEXTURE_TYPE_PLAIN;pelements->pMetaTexture[texture_unit] = (void*)ptexture;}
inline void NUT_SetEditorATxC_Elements_AtlasElement(NUT_EDITOR_ATXC_ELEMENTS *pelements, const Nu8 texture_unit, const NATLAS_ELEMENT *patlas_el  ){pelements->MetaTextureType[texture_unit]=NUT_EDITOR_ATXC_ELEMENTS_TEXTURE_TYPE_ATLAS_ELEMENT;pelements->pMetaTexture[texture_unit] = (void*)patlas_el;}
...
inline void NUT_SetEditorATxC_Elements_TexCoord_Controller(NUT_EDITOR_ATXC_ELEMENTS *pelements, const Nu32 TxCsetid, const NTEXCOORD_2f *poffset, const NTEXCOORD_2f *pscale ){NErrorIf(TxCsetid>=CONSTANT_NUT_EDITOR_ATXC_ELEMENTS_TEXCOORD_SET_NB,NERROR_VALUE_OUTOFRANGE);pelements->TexCoordOffset[TxCsetid]=*poffset;pelements->TexCoordScale[TxCsetid]=*pscale;}
inline void NUT_SetEditorATxC_Elements_TexCoord_Controllerf(NUT_EDITOR_ATXC_ELEMENTS *pelements, const Nu32 TxCsetid, const Nf32 offset_u, const Nf32 offset_v,const Nf32 scale_u, const Nf32 scale_v ){NErrorIf(TxCsetid>=CONSTANT_NUT_EDITOR_ATXC_ELEMENTS_TEXCOORD_SET_NB,NERROR_VALUE_OUTOFRANGE);pelements->TexCoordOffset[TxCsetid].x=offset_u;pelements->TexCoordOffset[TxCsetid].y=offset_v;pelements->TexCoordScale[TxCsetid].x=scale_u;pelements->TexCoordScale[TxCsetid].y=scale_v;}
inline void NUT_SetEditorATxC_Elements_TexCoord0_Controller(NUT_EDITOR_ATXC_ELEMENTS *pelements, const NTEXCOORD_2f *poffset, const NTEXCOORD_2f *pscale ){pelements->TexCoordOffset[0]=*poffset;pelements->TexCoordScale[0]=*pscale;}
inline void NUT_SetEditorATxC_Elements_TexCoord1_Controller(NUT_EDITOR_ATXC_ELEMENTS *pelements, const NTEXCOORD_2f *poffset, const NTEXCOORD_2f *pscale ){pelements->TexCoordOffset[1]=*poffset;pelements->TexCoordScale[1]=*pscale;}
inline void NUT_SetEditorATxC_Elements_TexCoord0_Controllerf(NUT_EDITOR_ATXC_ELEMENTS *pelements, const Nf32 offset_u, const Nf32 offset_v,const Nf32 scale_u, const Nf32 scale_v ){pelements->TexCoordOffset[0].x=offset_u;pelements->TexCoordOffset[0].y=offset_v;pelements->TexCoordScale[0].x=scale_u;pelements->TexCoordScale[0].y=scale_v;}
inline void NUT_SetEditorATxC_Elements_TexCoord1_Controllerf(NUT_EDITOR_ATXC_ELEMENTS *pelements, const Nf32 offset_u, const Nf32 offset_v,const Nf32 scale_u, const Nf32 scale_v ){pelements->TexCoordOffset[1].x=offset_u;pelements->TexCoordOffset[1].y=offset_v;pelements->TexCoordScale[1].x=scale_u;pelements->TexCoordScale[1].y=scale_v;}
