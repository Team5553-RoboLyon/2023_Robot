...
#define DEFAULT_NLPATH_BUILDER_PLG_VERTEX_ICR 0.0f
	...
	NLPATH_BUILDER_PLG_VERTEX() : flags(0), tl(DEFAULT_NLPATH_BUILDER_PLG_VERTEX_L), l(DEFAULT_NLPATH_BUILDER_PLG_VERTEX_L), icr(DEFAULT_NLPATH_BUILDER_PLG_VERTEX_ICR), lA(0.0f), lB(0.0f)
	{
