...
public:
	...
	inline NLKIN(const Nf32 s, const Nf32 v, const Nf32 a, const Nf32 j, const Nf32 t)
	{
		m_s = s;
		m_v = v;
		m_a = a;
	...
	inline void tjavs_set(const Nf32 t, const Nf32 j, const Nf32 a, const Nf32 v, const Nf32 s)
	{
		m_t = t;
		m_a = a;
		m_v = v;
	...
	inline void setAsKinX(const Nf32 j, const Nf32 a)
	{
		m_j = j;
		m_a = a;
		m_t = a / j;
		m_v = (a * a) / (2 * j);
		m_s = m_j * NPOW3(m_t) / 6.0f;
	}
	inline void reverse()
	{
		m_s = -m_s;
