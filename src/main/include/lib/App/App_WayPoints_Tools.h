...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// La fonction draw() de la classe NLPath ne dessine pas de poignées pour manipuler les arcs de cercle insérés.
...
typedef struct  
{
	...
	APP_HELPER_SNAPLINE		m_SnapLine[2];	// 2 structures utilisées pour tracer deux lignes ( "helper") de snap.
