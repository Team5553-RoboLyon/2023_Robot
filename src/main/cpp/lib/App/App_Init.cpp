...
#include "lib/N/Utilities/NVec3f32Tools/NUT_Editor_NVec3f32Pack_Tools.h"
...
#include "lib/NL/NL2DOrthogonalCoordinateSystemTools.h"
...
#include "lib/App/App_WayPoints_Tools.h"
#include "lib/App/App_PolygonalChain_Tools.h"
// #include "App_TestAndDebug_Tools.h"
#include "lib/App//Tools/App_UserVZones_Tools.h"
#include "lib/App//Tools/App_TrajectoryKey_Tools.h"
...
*/
// Structures utilis�es par les outils d'edition:
...
// Graphs
NL2DOCS OrthogonalCoordinateSystem_B;
...
NARRAY UpToDateActionMessagesLUT; // NLPROJECT contient la liste des ActionMessages qui seront utilis�es par le logiciel
								  // A chaque chargement/sauvegarde, la liste des ActionMessages du Projet sera compar�e avec cette "liste � jour"
								  // En cas de diff. Il sera demand� � l'utilisateur de choisir quelle liste utiliser ( i-e conserver la liste pas � jour
								  // contenue dans le projet ou mettre � jour la liste du projet avec la liste uptodate !!! )
								  // La liste UptoDate est cr��e � partir du fichier data/_actionmessages.txt qui fait donc reference pour le logiciel.
...
void App_Tools_Init()
{
	...
	OrthogonalCoordinateSystem_B.setup("Motion Profile - VIEW B", BITS_NL2DOCS_ORIGIN_LEFT_BOTTOM, &rect, &unit);
	OrthogonalCoordinateSystem_B.setCaptionColor(NCOLOR_PRESET3F_BLUE_AQUAMARINE, 1.0f);

	// Initialisation des Styles de coordonn�es de NL2DOCS
	...
	// NL2DOCS_COORDS_STYLE_1.......................... Defini et utilis� pour les valeurs en ordonn�es sur les NL2DOCS
...
void App_Tools_End()
{
	...
	//
	//	NErrorIf(WorkbenchArray.Size, NERROR_ARRAY_NOT_EMPTY); // L'array doit �tre compl�tement vide !
