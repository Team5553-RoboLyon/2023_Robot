...
void NLVIRTUAL_MOTOR::update(const Nf32 dt)
{
	...
	else
	{
		...
		// la diff�rence avec le volatage entrant va engendrer une variation de vitesse ( acceleration )
		ua = m_appliedVoltage - uv;
