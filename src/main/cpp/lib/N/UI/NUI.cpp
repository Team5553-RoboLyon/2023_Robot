...
#include "lib/N/Render/Renderable/NRenderable_Extract.h"
...
#include "lib/N/Geometry/NGeometryBoundingVolume.h"
#include "lib/N/Geometry/NGeometryVertexTransformations.h"
#include "lib/N/Geometry/Components/NGeometryVertex.h"
#include "lib/N/Geometry/Components/NGeometryTextureCoordinate.h"
#include "lib/N/Timer/NUIThnAnimationPlayer.h"
...
void NSetUIListenTouchMode(NUI *pui, const NUI_LISTEN_TOUCH_MODE_ENUM touch_mode)
{
	...
	case NUI_LISTEN_TOUCH_MODE_NULL:
		...
		if (ISFLAG_ON(pui->Flags, FLAG_NUI_LISTEN_TOUCH_EVENT_CAPTURE_MOVE_IN))
			NDisableUIListenTouch_CaptureMoveIn(pui);
		// Then update others
		FLAG_OFF(pui->Flags, FLAG_NUI_LISTEN_TOUCH_EVENT_CAPTURE_START | FLAG_NUI_LISTEN_TOUCH_EVENT_RELEASE_MOVE_OUT | FLAG_NUI_LISTEN_TOUCH_EVENT_TRACK_MOVE_IN_OUT);
		// That means:
	...
	case NUI_LISTEN_TOUCH_MODE_CATCH_TRACK:
		...
		FLAG_OFF(pui->Flags, FLAG_NUI_LISTEN_TOUCH_EVENT_CAPTURE_START | FLAG_NUI_LISTEN_TOUCH_EVENT_RELEASE_MOVE_OUT);
		// That means:
		// FLAG_ON(pui->Flags, FLAG_NUI_CAPTURE_TOUCH_MOVE_IN);
	...
	case NUI_LISTEN_TOUCH_MODE_CATCH_RELEASE:
		...
		FLAG_OFF(pui->Flags, FLAG_NUI_LISTEN_TOUCH_EVENT_CAPTURE_START | FLAG_NUI_LISTEN_TOUCH_EVENT_TRACK_MOVE_IN_OUT);
		// That means:
		// FLAG_ON(pui->Flags, FLAG_NUI_CAPTURE_TOUCH_MOVE_IN);
	...
	case NUI_LISTEN_TOUCH_MODE_BASIC:
		...
		FLAG_OFF(pui->Flags, FLAG_NUI_LISTEN_TOUCH_EVENT_RELEASE_MOVE_OUT | FLAG_NUI_LISTEN_TOUCH_EVENT_TRACK_MOVE_IN_OUT);
		// That means:
	...
	case NUI_LISTEN_TOUCH_MODE_BASIC_TRACK:
		...
		if (ISFLAG_ON(pui->Flags, FLAG_NUI_LISTEN_TOUCH_EVENT_CAPTURE_MOVE_IN))
			NDisableUIListenTouch_CaptureMoveIn(pui);
		// Then update others
		FLAG_ON(pui->Flags, FLAG_NUI_LISTEN_TOUCH_EVENT_CAPTURE_START | FLAG_NUI_LISTEN_TOUCH_EVENT_TRACK_MOVE_IN_OUT);
	...
	case NUI_LISTEN_TOUCH_MODE_DROP:
		...
		if (ISFLAG_ON(pui->Flags, FLAG_NUI_LISTEN_TOUCH_EVENT_CAPTURE_MOVE_IN))
			NDisableUIListenTouch_CaptureMoveIn(pui);
		// Then update others
		FLAG_ON(pui->Flags, FLAG_NUI_LISTEN_TOUCH_EVENT_CAPTURE_START | FLAG_NUI_LISTEN_TOUCH_EVENT_RELEASE_MOVE_OUT);
