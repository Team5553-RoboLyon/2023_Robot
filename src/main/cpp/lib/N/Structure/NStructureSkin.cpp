	...
	case NSKIN_SCHEME_ROPE_QUADS_DOUBLEROWS:
		...
		if (ISFLAG_ON(pbuilder->Rope.Flags, FLAG_NSKIN_DESC_TRIANGLE_CW_BUILDING))
		{
			for (i = 0; i < pbuilder->Rope.Ref_RangeSize - 1; i++)
			{
				...
				ptri[indextri + 1].i1 = topB + 1;
				ptri[indextri].i2 = topA;
				ptri[indextri + 1].i2 = topB;

				ptri[indextri + 2].i0 = topA + 2;
				ptri[indextri + 3].i0 = topA + 2;
				ptri[indextri + 2].i1 = topB + 1;
				ptri[indextri + 3].i1 = topB + 2;
				ptri[indextri + 2].i2 = topA + 1;
				ptri[indextri + 3].i2 = topB + 1;
		...
		else // CCW The default One
		{
			for (i = 0; i < pbuilder->Rope.Ref_RangeSize - 1; i++)
			{
				...
				ptri[indextri + 1].i2 = topB + 1;

				ptri[indextri + 2].i0 = topA + 2;
				ptri[indextri + 3].i0 = topA + 2;
				ptri[indextri + 2].i1 = topA + 1;
				ptri[indextri + 3].i1 = topB + 1;
				ptri[indextri + 2].i2 = topB + 1;
				ptri[indextri + 3].i2 = topB + 2;
