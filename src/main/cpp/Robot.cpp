...
void Robot::TeleopPeriodic()
{
  ...
  double tilt = m_TiltTracker.Update(0.02, (m_EncoderLeft.GetDistance() + m_EncoderRight.GetDistance()) * TRACTION_WHEEL_CIRCUMFERENCE / 2.0, m_FusAngle.GetAngle(), gyro_rate_degps);
