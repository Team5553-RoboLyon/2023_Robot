...
inline NVEC2*	NGetAtlasElementfPixSize(NVEC2 *psize, const NATLAS_ELEMENT *pel, const Nbool _refpix_src ){NVEC2s16 sizes16;if(_refpix_src){return NSize_RefPixTofPix(psize,NGetOAARects16Size(&sizes16,&pel->UsedOAARects16));}else{return NSize_PixTofPix(psize,NGetOAARects16Size(&sizes16,&pel->UsedOAARects16));}}
inline NVEC2*	NGetAtlasElementHRelSize(NVEC2 *psize, const NATLAS_ELEMENT *pel, const Nbool _refpix_src ){NVEC2s16 sizes16;if(_refpix_src){return NSize_RefPixToHRel(psize,NGetOAARects16Size(&sizes16,&pel->UsedOAARects16));}else{return NSize_PixToHRel(psize,NGetOAARects16Size(&sizes16,&pel->UsedOAARects16));}}
inline NVEC2*	NGetAtlasElementNormSize(NVEC2 *psize, const NATLAS_ELEMENT *pel, const Nbool _refpix_src ){NVEC2s16 sizes16;if(_refpix_src){return NSize_RefPixToNorm(psize,NGetOAARects16Size(&sizes16,&pel->UsedOAARects16));}else{return NSize_PixToNorm(psize,NGetOAARects16Size(&sizes16,&pel->UsedOAARects16));}}
