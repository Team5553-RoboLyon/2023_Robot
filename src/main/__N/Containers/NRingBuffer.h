...
//inline Nbool	NIsValidRingBufferRelativeIndex(const NRINGBUFFER *pringbuffer, const Nu32 id) {Nu32 absid = id + pringbuffer->Capacity; return (NSIGN(absid-(pringbuffer)->Head)==(NSIGN(absid-(pringbuffer)->Tail)) ? 0:1);}
inline Nbool	NIsValidRingBufferRelativeIndex(const NRINGBUFFER* pringbuffer, const Nu32 id) { return (id<pringbuffer->Size )? 1 : 0; }
inline	void*	NGetRingBufferAbsoluteIndexPtr(const NRINGBUFFER *pringbuffer, const Nu32 id){NErrorIf(!NIsValidRingBufferAbsoluteIndex(pringbuffer,id), NERROR_RINGBUFFER_INDEX_OUTOFRANGE);return (NBYTE*)pringbuffer->pBuffer + id*pringbuffer->ElementSize;}
inline	void*	NGetRingBufferHeadRelativeIndexPtr(const NRINGBUFFER *pringbuffer, const Nu32 id){NErrorIf(!NIsValidRingBufferRelativeIndex(pringbuffer,id), NERROR_RINGBUFFER_INDEX_OUTOFRANGE);return (NBYTE*)pringbuffer->pBuffer + ((pringbuffer->Tail + id)%pringbuffer->Size)*pringbuffer->ElementSize;}
...
void			NRingBufferPushBack(NRINGBUFFER *pringbuffer,const void *pelement);
void			NRingBufferPushBack_DropLatest(NRINGBUFFER *pringbuffer,const void *pelement);
void			NRingBufferPushBack_OverwriteOldest(NRINGBUFFER *pringbuffer,const void *pelement);
void			NRingBufferPushBack_OverwriteOldestXtd(NRINGBUFFER *pringbuffer,const void *pelement, NRINGBUFFER_ELEMENT_DESTRUCTOR_CALLBACK element_destructor_callback);
...
void*			NRingBufferPushBackXtd(NRINGBUFFER *pringbuffer,const void *pelement);
void*			NRingBufferPushBackXtd_DropLatest(NRINGBUFFER *pringbuffer,const void *pelement);
void*			NRingBufferPushBackXtd_OverwriteOldest(NRINGBUFFER *pringbuffer,const void *pelement);
void*			NRingBufferPushBackXtd_OverwriteOldestXtd(NRINGBUFFER *pringbuffer,const void *pelement, NRINGBUFFER_ELEMENT_DESTRUCTOR_CALLBACK element_destructor_callback);
...
Nu32			NRingBufferPushBackXtdI(NRINGBUFFER *pringbuffer,const void *pelement);
Nu32			NRingBufferPushBackXtdI_DropLatest(NRINGBUFFER *pringbuffer,const void *pelement);
Nu32			NRingBufferPushBackXtdI_OverwriteOldest(NRINGBUFFER *pringbuffer,const void *pelement);
Nu32			NRingBufferPushBackXtdI_OverwriteOldestXtd(NRINGBUFFER *pringbuffer,const void *pelement, NRINGBUFFER_ELEMENT_DESTRUCTOR_CALLBACK element_destructor_callback);
