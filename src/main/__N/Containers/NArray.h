...
#define NARRAYCHK_INCONSISTENCY		-3		// |__ Les valeurs de retour signalant un probleme potentiel sont négatives  
#define NARRAYCHK_NULLPTR			-2		// |
#define NARRAYCHK_ZEROS				-1		// |
#define NARRAYCHK_OK				 0		// +-- La valeur de retour "0" signale une égalité parfaite entre Array et BOUNDS
#define NARRAYCHK_AUTOSETUP			 1		// |
#define NARRAYCHK_SIZ_DIFF			 2		// |__ Les valeurs de retour > 0 signalent une incohérence non critique.
