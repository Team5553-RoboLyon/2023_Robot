...
void NUpdateTransformationTree()
{
	...
	// avoir plusieurs arbres séparés plutôt qu'une racine commune et unique !
	// ainsi on parcourt la liste des racines de chaques arbres et on s'enfonce dans l'arbre
	// si son bupdate continue est à ON.
	// il faudra veiller à ajouter un pointeur dans chaque htransformnode sur la racine de son arbre 
