...
inline void			NSetUIPlacementParent(NUIPLACEMENT *pplac, NUIPLACEMENT *ppar, const NVEC3 *panchor){pplac->pParent = ppar;pplac->ParentAnchor = *panchor;}
inline void			NSetUIPlacementParentf(NUIPLACEMENT *pplac, NUIPLACEMENT *ppar, const Nf32 x, const Nf32 y, const Nf32 z){pplac->pParent = ppar;pplac->ParentAnchor.x = x;pplac->ParentAnchor.y = y;pplac->ParentAnchor.z = z;}

inline void			NSetUIPlacementAnchor(NUIPLACEMENT *pplac, const NVEC3 *panchor){pplac->Anchor = *panchor;}
inline void			NSetUIPlacementAnchorf(NUIPLACEMENT *pplac,const Nf32 x, const Nf32 y, const Nf32 z){pplac->Anchor.x = x;pplac->Anchor.y = y;pplac->Anchor.z = z;}

inline void			NSetUIPlacementRelativePosition(NUIPLACEMENT *pplac, const NVEC3 *ppos){pplac->RelativePosition = *ppos;}
inline void			NSetUIPlacementRelativePositionf(NUIPLACEMENT *pplac,const Nf32 x, const Nf32 y, const Nf32 z){pplac->RelativePosition.x = x;pplac->RelativePosition.y = y;pplac->RelativePosition.z = z;}

inline void			NSetUIPlacementSize(NUIPLACEMENT *pplac, const NVEC3 *psize){pplac->Size = *psize;}
inline void			NSetUIPlacementSizef(NUIPLACEMENT *pplac,const Nf32 x, const Nf32 y, const Nf32 z){pplac->Size.x = x;pplac->Size.y = y;pplac->Size.z = z;}
