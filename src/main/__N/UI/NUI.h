...
inline	void		NEnableUIHierarchicalShowControl(NUI* pui){FLAG_ON(pui->FlagsXtd,FLAG_NUI_XTD_HIERARCHICAL_SHOW_CONTROL);}
...
inline NUI*			NGetFirstUIChild(const NUI* pui){if(NIS_NODE_VALID(pui->ChildrenList.pFirst,&pui->ChildrenList)){return (NUI*)pui->ChildrenList.pFirst;}else{return NULL;}}
inline NUI*			NGetLastUIChild(const NUI* pui){if(NIS_NODE_VALID(pui->ChildrenList.pLast,&pui->ChildrenList)){return (NUI*)pui->ChildrenList.pLast;}else{return NULL;}}


// Advanced UI Touch Listening 
inline void			NFullyOnScreenUITouchListeningRestriction(NUI *pui, const Nbool b){if(b){FLAG_ON(pui->Flags,FLAG_NUI_CAPTURE_TOUCH_ONLY_IF_FULLY_ON_SCREEN);}else{FLAG_OFF(pui->Flags,FLAG_NUI_CAPTURE_TOUCH_ONLY_IF_FULLY_ON_SCREEN);}}
...
// UI Touch Counts
inline void			NSetUITouchCountMax(NUI *pui, const Nu8 count_max){NErrorIf(pui->pTouchUIListener,NERROR_NON_NULL_VALUE);NErrorIf(count_max > CONSTANT_NTOUCH_COUNT_MAX, NERROR_VALUE_OUTOFRANGE );pui->TouchCountMax = count_max;} // Note that not allowed to update Touch Count Max of an UI that is listening touch ( pui->pTouchUIListener must be NULL ! )
...
inline NVEC3*	NGetUIGeometryDescCustomGeometrySize(NVEC3 *psize, const NUIGEOMETRY_DESC* pgd){NErrorIf(ISFLAG_OFF(pgd->Flags,FLAG_NUIGD_USEPARAM_CUSTOM_GEOMETRY) || (!pgd->pCustomGeometry) , NERROR_UIGEOMETRYDESC_CUSTOM_GEOMETRY_REQUESTED);NAABB	aabb;NGetGeometryAABB( pgd->pCustomGeometry,&aabb );return NGetAABBSize(psize,&aabb);}
inline NVEC2s16* NGetUIGeometryDescTextureUnitSizes16(NVEC2s16 *psize, const NUIGEOMETRY_DESC* pgd, const Nu8 texture_unit){NErrorIf( ISFLAG_OFF(pgd->Flags,FLAG_NUIGD_USEPARAM_APPEARANCE) || (!NGetAppearance_Raw_Texture(&((NUIGEOMETRY_DESC*)pgd)->Appearance_Raw,texture_unit)), NERROR_UIGEOMETRYDESC_TEXTURE_REQUESTED);NTEXTURE *ptexture = NGetAppearance_Raw_Texture(&((NUIGEOMETRY_DESC*)pgd)->Appearance_Raw,texture_unit);*psize = ptexture->size;return psize;}
inline NVEC2*	NGetUIGeometryDescTextureUnitHRelSize(NVEC2 *psize, const NUIGEOMETRY_DESC* pgd, const Nu8 texture_unit){NErrorIf( ISFLAG_OFF(pgd->Flags,FLAG_NUIGD_USEPARAM_APPEARANCE) || (!NGetAppearance_Raw_Texture(&((NUIGEOMETRY_DESC*)pgd)->Appearance_Raw,texture_unit)), NERROR_UIGEOMETRYDESC_TEXTURE_REQUESTED);NTEXTURE *ptexture = NGetAppearance_Raw_Texture(&((NUIGEOMETRY_DESC*)pgd)->Appearance_Raw,texture_unit);return NSize_PixToHRel(psize,&ptexture->size);}

inline void			NSetUIGeometryDescAnchor(NUIGEOMETRY_DESC* pgd, const NVEC3 *panchor){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_ANCHOR);NSetUIPlacementAnchor(&pgd->Placement, panchor);}
inline void			NSetUIGeometryDescAnchorf(NUIGEOMETRY_DESC* pgd,const Nf32 x, const Nf32 y, const Nf32 z){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_ANCHOR);NSetUIPlacementAnchorf(&pgd->Placement,x,y,z);}
inline void			NSetUIGeometryDescCustomGeometry(NUIGEOMETRY_DESC* pgd, NGEOMETRY *pcustomgeom){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_CUSTOM_GEOMETRY);pgd->pCustomGeometry = pcustomgeom;}
inline void			NSetUIGeometryDescParent(NUIGEOMETRY_DESC* pgd, NUIPLACEMENT *pparentplac,const NVEC3 *panchor){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAMS_PLACEMENT_PARENT);NSetUIPlacementParent(&pgd->Placement, pparentplac, panchor);}
inline void			NSetUIGeometryDescParentf(NUIGEOMETRY_DESC* pgd, NUIPLACEMENT *pparentplac,const Nf32 x, const Nf32 y, const Nf32 z){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAMS_PLACEMENT_PARENT);NSetUIPlacementParentf(&pgd->Placement, pparentplac, x, y,z );}
inline void			NSetUIGeometryDescRelativePosition(NUIGEOMETRY_DESC* pgd, const NVEC3 *ppos){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_RELATIVE_POSITION);NSetUIPlacementRelativePosition(&pgd->Placement,ppos);}
inline void			NSetUIGeometryDescRelativePositionf(NUIGEOMETRY_DESC* pgd,const Nf32 x, const Nf32 y, const Nf32 z){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_RELATIVE_POSITION);NSetUIPlacementRelativePositionf(&pgd->Placement,x,y,z);}
inline void			NSetUIGeometryDescSize(NUIGEOMETRY_DESC* pgd, const NVEC3 *psize){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_SIZE);NSetUIPlacementSize(&pgd->Placement, psize);}
inline void			NSetUIGeometryDescSizef(NUIGEOMETRY_DESC* pgd,const Nf32 x, const Nf32 y, const Nf32 z){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_SIZE);NSetUIPlacementSizef(&pgd->Placement,x,y,z);}

inline NVEC3*	NSetUIGeometryDescSizeFromCustomGeometry(NUIGEOMETRY_DESC* pgd){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_SIZE);return NGetUIGeometryDescCustomGeometrySize(&pgd->Placement.Size,pgd);}
inline NVEC3*	NSetUIGeometryDescSizeFromTextureUnitSize(NUIGEOMETRY_DESC* pgd, const Nu8 texture_unit){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_SIZE);pgd->Placement.Size.z = 0.0f;return (NVEC3*)NGetUIGeometryDescTextureUnitHRelSize((NVEC2*)&pgd->Placement.Size,pgd,texture_unit);}
inline NVEC3*	NSetUIGeometryDescSizeFromAtlasElementSize(NUIGEOMETRY_DESC* pgd, const NATLAS_ELEMENT *pae,const Nbool _refpix_src){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_SIZE);pgd->Placement.Size.z = 0.0f;return (NVEC3*)NGetAtlasElementHRelSize((NVEC2*)&pgd->Placement.Size,pae,_refpix_src);}

inline NRECTf32*	NSetUIGeometryDescTexCoordUsedOAARectf32FromAtlasElement(NUIGEOMETRY_DESC* pgd, const NATLAS_ELEMENT *pae){FLAG_ON(pgd->TexCoordBuild.Flags,FLAG_NBUILDBASE_TEXCOORD_USEPARAM_USEDOAARECTf32);return NGetAtlasElementUsedOAARectf32(&pgd->TexCoordBuild.UsedOAARectf32,pae);}
inline void			NSetUIGeometryDescTexCoordUsedOAARectf32(NUIGEOMETRY_DESC* pgd, const NRECTf32 *ptextureusedOAArectf32){FLAG_ON(pgd->TexCoordBuild.Flags,FLAG_NBUILDBASE_TEXCOORD_USEPARAM_USEDOAARECTf32);pgd->TexCoordBuild.UsedOAARectf32 = *ptextureusedOAArectf32;}
inline void			NSetUIGeometryDescTexCoordSubAARectf32(NUIGEOMETRY_DESC* pgd, const NRECTf32 *ptexsubAArectf32){FLAG_ON(pgd->TexCoordBuild.Flags,FLAG_NBUILDBASE_TEXCOORD_USEPARAM_SUBAARECTf32);pgd->TexCoordBuild.SubAARectf32 = *ptexsubAArectf32;}
inline void			NSetUIGeometryDescTexCoordSetID(NUIGEOMETRY_DESC* pgd, const Nu8 texcoordsetid){NErrorIf(texcoordsetid > CONSTANT_NBUILDBASE_TEXCOORD_TEXCOORDSETID_MAX, NERROR_VALUE_OUTOFRANGE);FLAG_ON(pgd->TexCoordBuild.Flags,FLAG_NBUILDBASE_TEXCOORD_USEPARAM_TEXCOORDSETID);pgd->TexCoordBuild.TexCoordSetID = texcoordsetid;}

inline void			NSetUIGeometryDescBlendAndMaterial( NUIGEOMETRY_DESC* pgd, const NBLEND *pblend, const NMATERIAL *pmat){FLAG_ON(pgd->Flags,FLAG_NUIGD_USEPARAM_APPEARANCE);pgd->Appearance_Raw.pBlend = (NBLEND*)pblend;pgd->Appearance_Raw.pMaterial = (NMATERIAL*)pmat;}
inline void			NSetUIGeometryDescColorRange( NUIGEOMETRY_DESC* pgd, const NCOLOR* pcolorrange, const Nu32 colorrangesize){FLAG_ON(pgd->ColorBuild.Flags,FLAG_NBUILDBASE_COLOR_USEPARAMS_COLORRANGE);pgd->ColorBuild.pColorRange = (NCOLOR*)pcolorrange;pgd->ColorBuild.ColorRangeSize = colorrangesize;}
...
inline void			NSetUITextDescAnchor(NUITEXT_DESC* ptd, const NVEC3 *panchor){FLAG_ON(ptd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_ANCHOR);NSetUIPlacementAnchor(&ptd->Placement, panchor);}
inline void			NSetUITextDescAnchorf(NUITEXT_DESC* ptd,const Nf32 x, const Nf32 y, const Nf32 z){FLAG_ON(ptd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_ANCHOR);NSetUIPlacementAnchorf(&ptd->Placement,x,y,z);}
inline void			NSetUITextDescParent(NUITEXT_DESC* ptd, NUIPLACEMENT *pplac,const NVEC3 *panchor){FLAG_ON(ptd->Flags,FLAG_NUIGD_USEPARAMS_PLACEMENT_PARENT);NSetUIPlacementParent(&ptd->Placement, pplac, panchor);}
inline void			NSetUITextDescParentf(NUITEXT_DESC* ptd, NUIPLACEMENT *pplac,const Nf32 x,const Nf32 y, const Nf32 z){FLAG_ON(ptd->Flags,FLAG_NUIGD_USEPARAMS_PLACEMENT_PARENT);NSetUIPlacementParentf(&ptd->Placement, pplac, x,y,z);}
inline void			NSetUITextDescRelativePosition(NUITEXT_DESC* ptd, const NVEC3 *ppos){FLAG_ON(ptd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_RELATIVE_POSITION);NSetUIPlacementRelativePosition(&ptd->Placement,ppos);}
inline void			NSetUITextDescRelativePositionf(NUITEXT_DESC* ptd,const Nf32 x, const Nf32 y, const Nf32 z){FLAG_ON(ptd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_RELATIVE_POSITION);NSetUIPlacementRelativePositionf(&ptd->Placement,x,y,z);}
inline void			NSetUITextDescSize(NUITEXT_DESC* ptd, const NVEC3 *psize){FLAG_ON(ptd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_SIZE);NSetUIPlacementSize(&ptd->Placement, psize);}
inline void			NSetUITextDescSizef(NUITEXT_DESC* ptd,const Nf32 x, const Nf32 y, const Nf32 z){FLAG_ON(ptd->Flags,FLAG_NUIGD_USEPARAM_PLACEMENT_SIZE);NSetUIPlacementSizef(&ptd->Placement,x,y,z);}
...
inline void			NSetUITextDescBlendAndMaterial( NUITEXT_DESC* ptd, const NBLEND *pblend, const NMATERIAL *pmat){FLAG_ON(ptd->Flags,FLAG_NUIGD_USEPARAM_APPEARANCE);ptd->Appearance_Raw.pBlend = (NBLEND*)pblend;ptd->Appearance_Raw.pMaterial = (NMATERIAL*)pmat;}
inline void			NSetUITextDescColorRange( NUITEXT_DESC* ptd, const NCOLOR* pcolorrange, const Nu32 colorrangesize){FLAG_ON(ptd->ColorBuild.Flags,FLAG_NBUILDBASE_COLOR_USEPARAMS_COLORRANGE);ptd->ColorBuild.pColorRange = (NCOLOR*)pcolorrange;ptd->ColorBuild.ColorRangeSize = colorrangesize;}
inline void			NSetUITextDescAligment( NUITEXT_DESC* ptd, const NTEXT_ALIGNMENT_ENUM align){FLAG_ON(ptd->Flags,FLAG_NUIGD_USEPARAM_TEXT_ALIGNMENT);ptd->Alignment = align;}
