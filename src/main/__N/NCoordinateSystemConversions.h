...
inline NVEC2*	NCoord_PixToHRel(NVEC2 *phrel ,const NVEC2s16 *pscr){phrel->x=((Nf32)pscr->x)*NViewPort.InvHeight;phrel->y=((Nf32)-pscr->y)*NViewPort.InvHeight;return phrel;}
...
inline NVEC2s16*	NCoord_HRelToPix(NVEC2s16 *pscr, const NVEC2 *phrel){pscr->x=(Ns16)(phrel->x*(Nf32)NViewPort.Height);pscr->y=(Ns16)(-phrel->y*(Nf32)NViewPort.Height);return pscr;}
...
inline NVEC2*	NCoord_NormToHRel(NVEC2 *phrel ,const NVEC2 *pnorm){phrel->x=pnorm->x*NViewPort.AspectRatio;phrel->y=pnorm->y;return phrel;}
...
inline NVEC2*	NCoord_HRelToNorm(NVEC2 *pnorm ,const NVEC2 *phrel){pnorm->x=phrel->x*NViewPort.InvAspectRatio;pnorm->y=phrel->y;return pnorm;}
...
inline NVEC2s16*	NCoord_NormToPix(NVEC2s16 *pscr, const NVEC2 *pnorm){pscr->x=(Ns16)(pnorm->x*(Nf32)NViewPort.Width);pscr->y=(Ns16)(-pnorm->y*(Nf32)NViewPort.Height);return pscr;}
...
inline NVEC2*	NCoord_PixToNorm(NVEC2 *pnorm, const NVEC2s16 *pscr){pnorm->x=((Nf32)pscr->x)*NViewPort.InvWidth;pnorm->y=((Nf32)-pscr->y)*NViewPort.InvHeight;return pnorm;}
...
inline NVEC2*	NCoord_fPixToHRel(NVEC2 *phrel ,const NVEC2 *pscr){phrel->x = pscr->x*NViewPort.InvHeight;phrel->y = pscr->y*NViewPort.InvHeight;return phrel;}
...
inline NVEC2*	NCoord_HRelTofPix(NVEC2 *pscr, const NVEC2 *phrel){pscr->x=(phrel->x*(Nf32)NViewPort.Height);pscr->y=(phrel->y*(Nf32)NViewPort.Height);return pscr;}
...
inline NVEC2*	NCoord_NormTofPix(NVEC2 *pscr, const NVEC2 *pnorm){pscr->x=(pnorm->x*(Nf32)NViewPort.Width);pscr->y=(pnorm->y*(Nf32)NViewPort.Height);return pscr;}
...
inline NVEC2*	NCoord_fPixToNorm(NVEC2 *pnorm, const NVEC2 *pscr){pnorm->x=(pscr->x)*NViewPort.InvWidth;pnorm->y=(pscr->y)*NViewPort.InvHeight;return pnorm;}

inline Ns32			NCoord_fPixToPix_X(const Nf32 w){return (Ns32)w;}
inline Ns32			NCoord_fPixToPix_Y(const Nf32 h){return -(Ns32)h;}
inline NVEC2s16*	NCoord_fPixToPix(NVEC2s16 *pscr, const NVEC2 *pfscr){pscr->x=(Ns16)pfscr->x;pscr->y=-(Ns16)(pfscr->y);return pscr;}

inline Nf32			NCoord_PixTofPix_X(const Ns32 w){return (Nf32)w;}
inline Nf32			NCoord_PixTofPix_Y(const Ns32 h){return -(Nf32)h;}
inline NVEC2*	NCoord_PixTofPix(NVEC2 *pfscr, const NVEC2s16 *pscr){pfscr->x=(Nf32)pscr->x;pfscr->y=-(Nf32)pscr->y;return pfscr;}
...
inline NVEC2*	NSize_PixToHRel(NVEC2 *phrel ,const NVEC2s16 *pscr){phrel->x=((Nf32)pscr->x)*NViewPort.InvHeight;phrel->y=((Nf32)pscr->y)*NViewPort.InvHeight;return phrel;}
...
inline NVEC2s16*	NSize_HRelToPix(NVEC2s16 *pscr, const NVEC2 *phrel){pscr->x=(Ns16)(phrel->x*(Nf32)NViewPort.Height);pscr->y=(Ns16)(phrel->y*(Nf32)NViewPort.Height);return pscr;}
...
inline NVEC2*	NSize_NormToHRel(NVEC2 *phrel ,const NVEC2 *pnorm){phrel->x=pnorm->x*NViewPort.AspectRatio;phrel->y=pnorm->y;return phrel;}
...
inline NVEC2*	NSize_HRelToNorm(NVEC2 *pnorm ,const NVEC2 *phrel){pnorm->x=phrel->x*NViewPort.InvAspectRatio;pnorm->y=phrel->y;return pnorm;}
...
inline NVEC2s16*	NSize_NormToPix(NVEC2s16 *pscr, const NVEC2 *pnorm){pscr->x=(Ns16)(pnorm->x*(Nf32)NViewPort.Width);pscr->y=(Ns16)(pnorm->y*(Nf32)NViewPort.Height);return pscr;}
...
inline NVEC2*	NSize_PixToNorm(NVEC2 *pnorm, const NVEC2s16 *pscr){pnorm->x=((Nf32)pscr->x)*NViewPort.InvWidth;pnorm->y=((Nf32)pscr->y)*NViewPort.InvHeight;return pnorm;}
...
inline NVEC2*	NSize_fPixToHRel(NVEC2 *phrel ,const NVEC2 *pscr){phrel->x=(pscr->x)*NViewPort.InvHeight;phrel->y=(pscr->y)*NViewPort.InvHeight;return phrel;}
...
inline NVEC2*	NSize_HRelTofPix(NVEC2 *pscr, const NVEC2 *phrel){pscr->x=(phrel->x*(Nf32)NViewPort.Height);pscr->y=(phrel->y*(Nf32)NViewPort.Height);return pscr;}
...
inline NVEC2*	NSize_NormTofPix(NVEC2 *pscr, const NVEC2 *pnorm){pscr->x=(pnorm->x*(Nf32)NViewPort.Width);pscr->y=(pnorm->y*(Nf32)NViewPort.Height);return pscr;}
...
inline NVEC2*	NSize_fPixToNorm(NVEC2 *pnorm, const NVEC2 *pscr){pnorm->x=(pscr->x)*NViewPort.InvWidth;pnorm->y=(pscr->y)*NViewPort.InvHeight;return pnorm;}

inline Ns32			NSize_fPixToPix_W(const Nf32 w){return (Ns32)w;}
inline Ns32			NSize_fPixToPix_H(const Nf32 h){return (Ns32)h;}
inline NVEC2s16*	NSize_fPixToPix(NVEC2s16 *pscr, const NVEC2 *pfscr){pscr->x=(Ns16)pfscr->x;pscr->y=(Ns16)(pfscr->y);return pscr;}

inline Nf32			NSize_PixTofPix_W(const Ns32 w){return (Nf32)w;}
inline Nf32			NSize_PixTofPix_H(const Ns32 h){return (Nf32)h;}
inline NVEC2*	NSize_PixTofPix(NVEC2 *pfscr, const NVEC2s16 *pscr){pfscr->x=(Nf32)pscr->x;pfscr->y=(Nf32)pscr->y;return pfscr;}
...
inline NVEC2*	NCoord_RefPixToHRel(NVEC2 *phrel ,const NVEC2s16 *pscr){phrel->x=((Nf32)pscr->x)*NViewPort.RefRatio_Height;phrel->y=((Nf32)-pscr->y)*NViewPort.RefRatio_Height;return phrel;}
...
inline NVEC2*	NCoord_RefNormToHRel(NVEC2 *phrel ,const NVEC2 *pnorm){phrel->x=pnorm->x*(Nf32)NViewPort.RefWidth*NViewPort.RefRatio_Height;phrel->y=pnorm->y*(Nf32)NViewPort.RefHeight*NViewPort.RefRatio_Height;return phrel;}
...
inline NVEC2*	NSize_RefPixTofPix(NVEC2 *pfpix ,const NVEC2s16 *pscr){pfpix->x=((Nf32)pscr->x)*NViewPort.RefRatio;pfpix->y=((Nf32)pscr->y)*NViewPort.RefRatio;return pfpix;}
...
inline NVEC2*	NSize_RefPixToHRel(NVEC2 *phrel ,const NVEC2s16 *pscr){phrel->x=((Nf32)pscr->x)*NViewPort.RefRatio_Height;phrel->y=((Nf32)pscr->y)*NViewPort.RefRatio_Height;return phrel;}
...
inline NVEC2*	NSize_RefNormToHRel(NVEC2 *phrel ,const NVEC2 *pnorm){phrel->x=pnorm->x*(Nf32)NViewPort.RefWidth*NViewPort.RefRatio_Height;phrel->y=pnorm->y*(Nf32)NViewPort.RefHeight*NViewPort.RefRatio_Height;return phrel;}
...
inline NVEC2*	NSize_RefPixToNorm(NVEC2 *pnorm, const NVEC2s16 *pscr){pnorm->x=((Nf32)pscr->x)*NViewPort.RefRatio_Width;pnorm->y=((Nf32)pscr->y)*NViewPort.RefRatio_Height;return pnorm;}
