...
inline void	NSetupParticleEmitterComponent_Standard_Desc_DefaultEmissionPoint(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const NVEC3 *pv){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_DEFAULT_EMISSION_POINT); pemitter_std_desc->DefaultEmissionPoint =  *pv;}
inline void	NSetupParticleEmitterComponent_Standard_Desc_DefaultEmissionPointf(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 x,const Nf32 y,const Nf32 z){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_DEFAULT_EMISSION_POINT); NVec3Set( &pemitter_std_desc->DefaultEmissionPoint,x,y,z );}
...
inline void	NSetupParticleEmitterComponent_Standard_Desc_CartesianEmissionExtentsf(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 x,const Nf32 y,const Nf32 z){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_EMISSION_EXTENTS); NVec3Set( &pemitter_std_desc->EmissionExtents.Cartesian,x,y,z );}
inline void	NSetupParticleEmitterComponent_Standard_Desc_FastSphericEmissionExtentsf(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 radius,const Nu32 inclination,const Nu32 azimuth){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_EMISSION_EXTENTS); NSetFastSphericf(&pemitter_std_desc->EmissionExtents.FastSpheric,radius,inclination,azimuth );}
inline void	NSetupParticleEmitterComponent_Standard_Desc_FastCylindricEmissionExtentsf(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 radius,const Nf32 height,const Nu32 azimuth){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_EMISSION_EXTENTS); NSetFastCylindricf( &pemitter_std_desc->EmissionExtents.FastCylindric,radius,height,azimuth );}
...
inline void	NSetupParticleEmitterComponent_Standard_Desc_EmissionPosition_SetupHandle(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const NPARTICLE_SETUP_POSITION phandle){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_SETUP_EMISSIONPOSITION_HANDLE);pemitter_std_desc->pParticleSetupEmissionPosition = phandle;}

// SpeedDamping:
// SpeedDamping scale each particle speed 'at each turn'
inline void	NSetupParticleEmitterComponent_Standard_Desc_SpeedDamping(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 speeddamping){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_SPEEDDAMPING); pemitter_std_desc->SpeedDamping = speeddamping;}
// Gravity:
// To define Gravity force vector used by the emitter.
// Gravity is added to each particle speed 'at each turn'
inline void	NSetupParticleEmitterComponent_Standard_Desc_Gravity(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const NVEC3 *pgravity){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_GRAVITY); pemitter_std_desc->Gravity =  *(NVEC3*)pgravity;}
inline void	NSetupParticleEmitterComponent_Standard_Desc_Gravityf(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 x,const Nf32 y,const Nf32 z){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_GRAVITY); NVec3Set( &pemitter_std_desc->Gravity,x,y,z );}
...
//
inline void	NSetupParticleEmitterComponent_Standard_Desc_LifeSpan_Params(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 base,const Nf32 var){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_LIFESPAN_AND_VARIATION);pemitter_std_desc->LifeSpan.Base = base;pemitter_std_desc->LifeSpan.Variation = var;}
...
//
inline void	NSetupParticleEmitterComponent_Standard_Desc_BirthRotation_Params(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 base,const Nf32 var){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_BIRTH_ROTATION_AND_VARIATION);pemitter_std_desc->BirthRotation.Base = base;pemitter_std_desc->BirthRotation.Variation = var;}
...
//
inline void	NSetupParticleEmitterComponent_Standard_Desc_BirthRotationSpeed_Params(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 base,const Nf32 var){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_BIRTH_ROTATIONSPEED_AND_VARIATION);pemitter_std_desc->BirthRotationSpeed.Base = base;pemitter_std_desc->BirthRotationSpeed.Variation = var;}
...
inline void	NSetupParticleEmitterComponent_Standard_Desc_CartesianBirthSpeedf_Params(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 xbase,const Nf32 ybase,const Nf32 zbase,const Nf32 xvar,const Nf32 yvar,const Nf32 zvar){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_BIRTH_SPEED_AND_VARIATION);NVec3Set(&pemitter_std_desc->BirthSpeed.Base.Cartesian,xbase,ybase,zbase);NVec3Set(&pemitter_std_desc->BirthSpeed.Variation.Cartesian,xvar,yvar,zvar);}
inline void	NSetupParticleEmitterComponent_Standard_Desc_FastSphericBirthSpeedf_Params(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 radiusbase,const Nu32 inclibase,const Nu32 azimbase,const Nf32 radiusvar,const Nu32 inclivar,const Nu32 azimvar){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_BIRTH_SPEED_AND_VARIATION);NSetFastSphericf(&pemitter_std_desc->BirthSpeed.Base.FastSpheric,radiusbase,inclibase,azimbase);NSetFastSphericf(&pemitter_std_desc->BirthSpeed.Variation.FastSpheric,radiusvar,inclivar,azimvar);}
inline void	NSetupParticleEmitterComponent_Standard_Desc_FastCylindricBirthSpeedf_Params(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const Nf32 radiusbase,const Nf32 hbase,const Nu32 azimbase,const Nf32 radiusvar,const Nf32 hvar,const Nu32 azimvar){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_BIRTH_SPEED_AND_VARIATION);NSetFastCylindricf(&pemitter_std_desc->BirthSpeed.Base.FastCylindric,radiusbase,hbase,azimbase);NSetFastCylindricf(&pemitter_std_desc->BirthSpeed.Variation.FastCylindric,radiusvar,hvar,azimvar);}
...
// !!! IMPORTANT !!! Both need to use the same coordinates system
inline void	NSetupParticleEmitterComponent_Standard_Desc_EmissionSpeed_SetupHandle(NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC *pemitter_std_desc,const NPARTICLE_SETUP_SPEED phandle){FLAG_ON(pemitter_std_desc->Flags, FLAG_NPARTICLE_EMITTERCOMPONENT_STANDARD_DESC_USE_SETUP_EMISSIONSPEED_HANDLE);pemitter_std_desc->pParticleSetupEmissionSpeed = phandle;}
